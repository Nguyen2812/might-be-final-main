...
public class Climber extends SubsystemBase {
  private final CANSparkMax leftClimberMotor = new CANSparkMax(20, MotorType.kBrushless);
  private final CANSparkMax rightClimberMotor = new CANSparkMax(21, MotorType.kBrushless);
